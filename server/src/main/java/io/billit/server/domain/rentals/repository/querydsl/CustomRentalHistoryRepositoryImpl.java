...
import static io.billit.server.domain.payments.entity.QRentalPayments.rentalPayments;
import static io.billit.server.domain.rentals.entity.QRentalHistory.rentalHistory;
import static io.billit.server.domain.rentals.entity.QRentalItemTypes.rentalItemTypes;
import static io.billit.server.domain.rentals.entity.QRentalItems.rentalItems;
import static io.billit.server.domain.rentals.entity.QRentalStations.rentalStations;
import static io.billit.server.domain.rentals.entity.RentalStatus.OVERDUE;
import static io.billit.server.domain.rentals.entity.RentalStatus.RENTAL;
import static io.billit.server.domain.users.entity.QUsers.users;
