package io.billit.server.domain.users.controller;
...
import io.billit.server.config.AbstractIntegrationTest;
import io.billit.server.domain.rentals.entity.RentalItemCategory;
import io.billit.server.domain.rentals.entity.RentalItemStatus;
...
import io.billit.server.domain.users.controller.request.UserChangeNicknameRequest;
import io.billit.server.domain.users.controller.request.UserChangePasswordRequest;
import io.billit.server.domain.users.controller.request.UserChangeProfileImageRequest;
import io.billit.server.domain.users.controller.response.S3PreSignedUrlResponse;
import io.billit.server.domain.users.controller.response.UserGetActiveRentalResponse;
import io.billit.server.domain.users.controller.response.UserGetSimpleResponse;
import io.billit.server.domain.users.entity.BookmarkStations;
import io.billit.server.domain.users.entity.ProviderType;
import io.billit.server.domain.users.entity.Role;
import io.billit.server.domain.users.entity.Users;
import io.billit.server.domain.users.repository.UserRepository;
import io.billit.server.global.aws.S3Service;
import io.billit.server.global.jwt.GenerateToken;
import io.billit.server.global.jwt.JwtProvider;
import io.billit.server.util.EntityFixture;
